...
const AttendeeListItem: React.FC<AttendeeListItemProps> = ({ attendee, onSelect }) => {
    let statusClasses = '';
    ...
    const packageIcon = (attendee.(packageType === PackageType.SITIO_BUS || packageType === PackageType.SITIO_BUS_DISCOUNT) || attendee.(packageType === PackageType.SITIO_BUS || packageType === PackageType.SITIO_BUS_DISCOUNT)_DISCOUNT) 
